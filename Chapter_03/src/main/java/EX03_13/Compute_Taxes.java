...
public class Compute_Taxes {
    public static void main(String [] args){
        ...
        System.out.println("Enter your status, 0-Single filer, 1-Married jointly or qualifying widow,\n2-Married separately, 3-head of household");
        ...
        if(status == 0){
            if(income <= 8350)
             ...
             if(income <= 16700)
                ...
                tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28 + (income - 208851) * 0.33;
            else
